...
class Solution:
    ...
    # Day-07: 09/Aug/2026
    # Recognition Pattern: Problem guarantees an element appears more than ⌊n/2⌋ times and follow-up asks for O(1) space 
        # → Think pairwise cancellation (Boyer-Moore).
    # Pattern: Boyer-Moore Voting Algorithm
    # Intuition:
        # Pairwise cancel different elements. 
        # Since the majority element appears more than all other elements combined, it can never be fully cancelled. 
        # Count represents the number of unmatched occurrences of the current candidate after all cancellations so far.
    # TC = O(n), SC = O(1)
    # Mistakes Made:
        # None
        # Rating: 5/5
